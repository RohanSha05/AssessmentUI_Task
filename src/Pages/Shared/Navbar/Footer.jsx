...
const Footer = () => {
  return (
		<footer className="bg-gray-900 text-stark py-12">
			<div className="container mx-auto px-4">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div>
						<h2 className="text-2xl font-bold mb-4">ASSESSMENT UI</h2>
						<p>
							ASSESSMENT UI is your go-to partner for cutting-edge technology
							solutions. We specialize in delivering custom software and web
				...
				<div className="mt-8">
					...
					<p>
						Stay updated with the latest news and offers from Tech Innovators.
					</p>
