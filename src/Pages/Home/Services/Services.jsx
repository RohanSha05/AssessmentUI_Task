...
const Services = () => {
  ...
  return (
    <div className="services-section py-20 px-20 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 text-sm">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-gradient-to-r from-[#362063] to-[#4b2a8a] text-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 relative"
          >
            ...
            <div className="p-6 text-start">
              <h2 className="text-2xl mb-2 text-white my-4">
                {service.title}
              </h2>
              <p className="my-4 text-white w-72">
                {service.description}
              </p>
            </div>
