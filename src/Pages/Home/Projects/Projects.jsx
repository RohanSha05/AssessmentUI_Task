...
const Projects = () => {
  ...
  return (
    <div className="projects-section py-16 px-8">
      <h1 className="text-4xl font-bold text-center mb-6 text-white">Our Projects</h1>
      <p className="text-white text-center text-xl mb-6">These are the recent projects made by us</p>
      <Swiper
        slidesPerView={1}
        spaceBetween={30}
        pagination={{
      ...
      >
        {projects.map((project, index) => (
          <SwiperSlide key={index}>
            ...
            >
              <div className="absolute inset-0 bg-black bg-opacity-40 transition-opacity duration-500 hover:bg-opacity-70"></div>
