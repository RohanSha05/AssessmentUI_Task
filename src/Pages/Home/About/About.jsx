...
const About = () => {
  return (
    <div className="about-section py-16 px-8 text-white">
      <h1 className="text-4xl font-bold text-center">About Us</h1>
      <p className="text-center mb-7 mt-4 text-xl">We are recognized as the best</p>
      <div className="w-full flex flex-col md:flex-row items-center bg-gradient-to-r from-[#362063] to-[#4b2a8a] rounded-md">
        <div className="md:w-1/2 p-10 text-center md:text-left md:pr-8 fade-in-left">
          ...
          <p className="text-lg md:text-xl mb-8">
            Empowering businesses through innovation and proven expertise. Our track
            record of success sets us apart, delivering tailored solutions to
            elevate your digital presence and drive sustainable growth.
          </p>
          <button className="bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition duration-300 fade-in-up">
            MORE DETAILS
          </button>
        </div>
