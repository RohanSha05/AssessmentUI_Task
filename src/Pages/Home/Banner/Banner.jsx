		...
		<div className="">
			<div className="carousel w-full">
				<div id="slide1" className="carousel-item">
					...
					<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-2xl animated-text text-stark">
						<h1 className="text-8xl font-bold">Welcome to AssessmentUI</h1>
